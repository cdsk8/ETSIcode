	...
	do{
		...
		switch(accion){
			...
			case 3:
				...
				cin >> nuevoS;
				p.cambiarstock(nuevoS);
				system("cls");
				break;
			case 4:
				p.leestock(i);
				cout << "\nNombre del producto: " << nomb;
				cout << "\nPrecio del producto: " << p.leeprecio();
			...
			case 6:
				break;
			default:
				cout << "\nNo se reconoce la accion. Pulse una tecla para continuar.";
				cin.ignore();
				cin.ignore();
				system("cls");
				break;
